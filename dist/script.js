...
window.addEventListener("DOMContentLoaded", function () {
  ...
  feedSlider.init();
  var oldOfficer = new _modules_differences__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officer__card-item');
  oldOfficer.init();
  var newOfficer = new _modules_differences__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', '.officer__card-item');
  newOfficer.init();
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "addEvent",
    value: function addEvent(selector, n) {
      var _this2 = this;
