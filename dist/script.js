...
/* harmony import */ var _modules_differences__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/differences */ "./src/js/modules/differences.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  mainSlider.render();
  var mainPageSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next',
    next: '.nextmodule',
    prev: '.prevmodule'
  ...
  feedSlider.init();
  new _modules_differences__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officer__card-item').init();
  new _modules_differences__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', '.officer__card-item').init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form', 'assets/question.php').init();
  new _modules_accordion__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus .plus__content', '.msg').init();
...
/*#__PURE__*/
function () {
  function Difference(blockSelector, items) {
    _classCallCheck(this, Difference);

    this.blockSelector = document.querySelector(blockSelector);

    try {
      this.items = this.blockSelector.querySelectorAll(items);
    } catch (e) {}
  ...
  _createClass(Difference, [{
    ...
    value: function bindTriggers() {
      ...
      this.blockSelector.querySelector('.plus').addEventListener('click', function () {
        if (_this.counter !== _this.items.length - 2) {
          _this.items[_this.counter].style.display = 'flex';

          _this.items[_this.counter].classList.add('fadeInUp');
...
/* harmony import */ var _sliders__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./sliders */ "./src/js/modules/slider/sliders.js");
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, animated, autoplay, activeClass) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, animated, autoplay, activeClass));
  }
